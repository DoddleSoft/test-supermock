...
export default function ListeningTestPage() {
  ...
  const sections = [
    {
      id: 1,
      title: "Section 1",
      description: "Conversation between two people in everyday context",
      questions: "1-10",
    },
    {
      id: 2,
      title: "Section 2",
      description: "Monologue in everyday context",
      questions: "11-20",
    },
    {
      id: 3,
          ...
          <button
            onClick={() => {
              if (selectedSection) {
                setIsStarted(true);
                setCurrentQuestion(
                  sections[selectedSection - 1].questions.split(
                    "-"
  ...
  return (
    <div className="min-h-screen bg-white">
      <ListeningNavbar timeLeft={timeLeft} />
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-2xl bg-white p-4">
            ...
            <div className="mt-6 rounded-lg bg-blue-50 p-4">
              <p className="text-sm text-blue-700">
                <strong>Note:</strong> You will hear the recording only once.
          ...
          <div className="rounded-2xl bg-white p-4">
            <h2 className="mb-6 text-lg font-semibold text-gray-900">
              Questions {sections[currentSection - 1]?.questions}
            </h2>
